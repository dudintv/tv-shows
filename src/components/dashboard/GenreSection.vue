...
const itemsCount = computed(() => mockShows.length);
...
<template>
  <GenreHeader :itemsCount="itemsCount" :progress="scrollProgress" />
  <div class="bleeding-full-width -mt-8">
    <div ref="scrollerRef" class="scroll-container px-8 sm:px-12 md:px-16 py-16 flex gap-8">
      <ShowListItem
        :show="mockShow"
        v-for="mockShow in mockShows"
        :key="mockShow.id"
        class="flex-shrink-0"
      />
    </div>
